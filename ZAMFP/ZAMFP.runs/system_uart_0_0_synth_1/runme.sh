...
HD_PWD='D:/Projects/ZAMFP25Z/ZAMFP/ZAMFP.runs/system_uart_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_uart_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_uart_0_0.tcl
